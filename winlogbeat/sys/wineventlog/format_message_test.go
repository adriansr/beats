...
func TestFormatMessage(t *testing.T) {
	...
	t.Run("getMessageStringFromHandle", func(t *testing.T) {
		t.Run("no_metadata", func(t *testing.T) {
			t.Skip("This currently fails under Win10. The message strings are returned with no metadata.")
	...
	t.Run("getEventXML", func(t *testing.T) {
		t.Run("no_metadata", func(t *testing.T) {
			t.Skip("This currently fails under Win10. The event XML is returned with no metadata.")
